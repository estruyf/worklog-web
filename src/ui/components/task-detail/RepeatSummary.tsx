...
export function RepeatSummary({
  ...
  return (
    <SidebarSection>
      <div className="px-[14px] py-[11px] border border-brand-375 bg-brand-100 rounded-panel text-control text-neutral-750">
        <div className="flex items-center gap-[7px] font-semibold text-brand-800">
          <RefreshCwIcon className="w-[13px] h-[13px] shrink-0" />
