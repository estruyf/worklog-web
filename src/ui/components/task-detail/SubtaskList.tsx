...
import { Button, Card, LinkButton, SectionLabel } from '../../primitives';
 ...
 *  it adds to is on screen when you press it. The *first* subtask is added from
 *  `TaskContentActions` instead, which is why this renders nothing at all with no
 *  children: a heading over an empty list is a heading over a heading. A done task
 *  keeps its list as a record but loses the button, for the same reason its header
 *  loses "Mark done".
 *
  ...
  return (
    ...
    <div className="mt-9 mb-7">
      <div className="flex items-center justify-between gap-3 mb-[10px]">
        <SectionLabel>Subtasks · {doneCount}/{subtasks.length} done</SectionLabel>
