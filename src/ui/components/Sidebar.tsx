...
import { Badge, Button, IconButton, SectionLabel } from '../primitives';
...
const brandGlyph = <img src="/worklog-logo-outline.svg" alt="" width="20" height="20" className="rounded-chip" />;
