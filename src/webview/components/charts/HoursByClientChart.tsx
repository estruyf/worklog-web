...
export function HoursByClientChart({ rows }: { rows: MonthlyRow[] }) {
  ...
  return (
    <div className="border border-[#E5E7EB] rounded-[11px] px-[18px] py-[18px] mb-[26px]">
      <div className="text-[11px] font-bold tracking-[0.05em] text-[#6E7781] mb-[14px]">HOURS BY CLIENT</div>
